export const events: {
...
}[] = [
  {
    ...
    events_date: new Date(2025, 5, 25),
  },
  {
    id: 2,
    title: "Acara 2",
    excerpt:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eget nisl eu nisi rhoncus porta. Morbi ultrices urna ac felis euismod, ut placerat ante accumsan. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec vehicula dictum vehicula. Aliquam erat volutpat. Proin at justo fermentum, fermentum lectus at, vulputate felis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus id tellus ut dolor dignissim maximus sed ut libero. Duis ipsum lectus, volutpat congue velit non, dapibus finibus tellus.",
    body: "",
    author: "Pihak Lain",
    imageUrl: "/images/banner/banner-1.jpg",
    category: "Capacity Building",
    created_at: new Date(Date.now()),
    events_date: new Date(2024, 5, 25),
  },
  {
    id: 3,
    ...
    body: "",
    author: "Yayasan Jantung Indonesia",
    imageUrl: "/images/banner/banner-6.jpg",
    category: "Capacity Building",
    created_at: new Date(Date.now()),
    events_date: new Date(2023, 8, 14),
  },
  {
    id: 4,
    title: "Acara Lokal",
    ...
    imageUrl: "/images/banner/banner-20.jpg",
    category: "Health",
    created_at: new Date(Date.now()),
    events_date: new Date(2021, 5, 20),
  },
  {
    id: 5,
    title: "Acara 5",
    ...
    body: "",
    author: "Yayasan Jantung Indonesia",
    imageUrl: "/images/banner/banner-19.jpg",
    category: "Seminar",
    created_at: new Date(Date.now()),
    events_date: new Date(2022, 3, 27),
  },
];
